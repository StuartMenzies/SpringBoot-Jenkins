pipeline {
	...
	environment {
		appIP="34.141.145.23";
		gitRepo="https://github.com/StuartMenzies/SpringBoot-Jenkins.git";
		repoName="SpringBoot-Jenkins";
		databaseIP="35.204.117.94";
	}
	stages{
...
spring.datasource.password=stuartdb > ./src/main/resources/application-dev.properties
			mvn clean package
			'''
			}
		}
